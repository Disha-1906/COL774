...
import numpy as np
from part_c_train import BasicBlock,ResNet
...
if __name__ == "__main__":
    ...
    model = ResNet(BasicBlock, [2, 2, 2, 2], num_classes=8)  # ResNet-18 # Make sure this class is defined elsewhere in your code
